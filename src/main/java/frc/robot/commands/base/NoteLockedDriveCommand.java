...
public class NoteLockedDriveCommand extends Command {
  CommandSwerveDrivetrain drivetrain;
  private double forward;
  private double strafe;
  private Vision vision;

  public NoteLockedDriveCommand(CommandSwerveDrivetrain drivetrain, Vision vision, double forward, double strafe) {
  ...
  public void execute() {
    this.drivetrain.drive(
        ...
        vision.getTx(VisionType.INTAKE),
